...
Answers sent manually from the linked account are accepted from linked devices,
including WhatsApp for Mac. Messages generated by the headless bot itself are
